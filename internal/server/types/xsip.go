...
// XSIPRequest structure for XSIP orders
type XSIPRequest struct {
	...
	XSIPMandateID     string `json:"xsip_mandate_id,omitempty" validate:"max=20"`
	SubBrCode         string `json:"sub_br_code,omitempty" validate:"max=15"`
	EUIN              string `json:"euin,omitempty" validate:"max=15"`
	EUINFlag          string `json:"euin_flag,omitempty" validate:"oneof=Y N"`
	DPC               string `json:"dpc,omitempty" validate:"max=10"`
	XSIPRegID         string `json:"xsip_reg_id,omitempty" validate:"max=20"`
...
// XSIPOrderResponse represents the response from XSIP order entry
...
// EnhancedXSIPCancellationRequest for enhanced XSIP cancellation
...
// EnhancedXSIPCancellationResponse for enhanced XSIP cancellation response
